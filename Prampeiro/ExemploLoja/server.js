...
const Pessoa = require('./src/model/Pessoa.js') // importa a classe Pessoa
...
//trata a rota /menu, e o que tem na frente é tratado como parêmetro
//exemplo rota /menu/prampero -> o nome vai receber prampero
...
app.post('/salvar', function (req, res) {
    ...
    try {
        ...
        obj.idade = parseInt(req.body.txtIdade)
        obj.peso = parseFloat(req.body.txtPeso)
...
app.get('/listar', function (req, res) {
    try {
        res.render("mostraPessoa", { clientes: vetor });
    }
    catch (erro) {
        console.log("Erro: " + erro) // vai para o terminal
        res.send("Erro: " + erro) // vai para o browser
